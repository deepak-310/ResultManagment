...
<body>
     ...
     <nav class="navbar">
      ...
      <h1 class="heading"><a href="adminresult.php"><i class="fas fa-arrow-left" style="color:black;font-weight: 300px;"></i></a> Result</h1>
            ...
            <table class="Marks_entry_table">
              ...
              <td><?php echo $res['status']; ?></td>
                ...
                <a href="resultpdf.php?sr=<?php echo $res['sr'];?>" target="_blank" data-toggle="tooltip" data-placement="bootom" title="RESULT "><button class="edit_btn" style="background-color: rgb(17, 180, 180);"><i class="fas fa-file"></i></button></a>
                 <a href="marks2.php?sr=<?php echo $res['sr'];?>"> <button class="delet_btn" id="delete_open" style="background-color: blue;">Marks</button></a>
                </td>
              </tr>
              <?php } ?>
            </table>
