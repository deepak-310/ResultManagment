...
<body>
     ...
     <nav class="navbar">
      ...
      <h1 class="heading"><a href="admindashboard.php"><i class="fas fa-arrow-left" style="color:black;font-weight: 300px;"></i></a> Result</h1>
      <?php
        ...
        ?>
      <form method="POST" action="adminresult2.php">
