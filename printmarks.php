...
<body>
     ...
     <nav class="navbar">
      ...
      <h1 class="heading"><a href="teacherdashboard.php"><i class="fas fa-arrow-left" style="color:black;font-weight: 300px;"></i></a> Print Marks</h1>
      ...
      <div class="table_borde">
        ...
        ?>
        <form action="printmarks2.php" method="post">
