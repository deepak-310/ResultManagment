...
<body>
     ...
     <nav class="navbar">
      ...
      <div class="table_borde">
        <h3 class="table_heading"> Subject</h3><hr style="border-top: 2px solid black;">
        <div class="btn_class">
          <a href="addsubject.php"><button class="add_btn" id="AddBtn">+ Add Subject</button></a>
...
?>
          <tr>
            ...
            <a href="editsubject.php?sr=<?php echo $res['sr']; ?>" data-toggle="tooltip" data-placement="bootom" title="UPDATE"><button class="edit_btn"><i class="fas fa-edit"></i></button></a>
            <a href="subjectdelete.php?sr=<?php echo $res['sr']; ?>" data-toggle="tooltip" data-placement="bootom" title="DELETE"><button class="delet_btn"><i class="fas fa-trash-alt"></i></button></a>
            </td>
