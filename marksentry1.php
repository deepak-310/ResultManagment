...
<body>
     ...
     <nav class="navbar">
      ...
      <h1 class="heading"><a href="teacherdashboard.php"><i class="fas fa-arrow-left" style="color:black;font-weight: 300px;"></i></a> Marks Entry</h1>
      ...
      <div class="table_borde">
        ...
        ?>
        <form action="marksentry2.php" method="post">
        <div class="selected_content">
            ...
            <div class="btn_class">
                ...
                <input type="submit" class="add_btn" style="margin-left: 5rem;padding: 10px 20px;" name="submit">
